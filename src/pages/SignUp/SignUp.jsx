...
const SignUp = () => {
  ...
  const { createUser, updateUser, loading, setLoading, signInWithGoogle } =
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
              ...
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  {errors.password?.type === "maxLength" && (
                    <span className="text-red-600">Maximum 15 characters</span>
                  )}
                  {errors.password?.type === "pattern" && (
                    <span className="text-red-600">
                      Enter a uppercase and a special character
                    </span>
                  )}
                  <span
                ...
                >
                  {loading ? (
                    ...
                    <span className="flex">
                      ...
                      <span className="mt-[5px] ml-2">Sign Up</span>
                    </span>
                  )}
                </button>
              </div>
              <p className="font-semibold">
                ...
                <Link to="/login">
                  <span className="text-orange-600 ml-2">LogIn</span>
                </Link>
              </p>
            </form>
            ...
            <div
              ...
              className="flex flex-row justify-center items-center mb-8 mt-2"
            >
              <span className="btn bg-white border-none hover:bg-white">
                <FcGoogle size={36}></FcGoogle>
              </span>
            </div>
          </div>
        </div>
